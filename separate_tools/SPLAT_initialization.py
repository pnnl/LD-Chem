...
from multipart.scenario import get_aero_spec_fracs
from scipy.optimize import curve_fit
#import tqdm
from multipart.particles import make_particle
...
diameters, num_concs, aero_spec_names, aero_spec_fracs, pHs, gas_data=splat_setup(Npart=total_Np,
                       ...
                       size_distribution_file='../src/multipart/datasets/HISCALE_data_0425/BEASD_G1_20160425155810_R2_HISCALE_001s.txt',
                       splat_file='../src/multipart/datasets/HISCALE_data_0425/Splat_Composition_25-Apr-2016.txt',
                       aimms_file='../src/multipart/datasets/HISCALE_data_0425/AIMMS20_G1_20160425155810_R2_HISCALE020h.txt',
                       trace_gas_folder='../src/multipart/datasets/HISCALE_data_0425/CIMS_data',
                       dz=100.0, splat_species=splat_species,
                       mass_fractions=mass_fractions,
                       gas_names=gas_names, les_path=les_path, les_number=les_number,
                       ams_file='../src/multipart/datasets/HISCALE_data_0425/HiScaleAMS_G1_20160425_R0.txt',
                       override_matching=False,
                       specdata_path='../src/multipart/species_data/')
