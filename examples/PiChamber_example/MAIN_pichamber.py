...
This example script demonstrates how to run Pi Chamber trajectory simulations using multipart. 
...
# 'gas': dict of 1D arrays of gas-phase species concentrations (ppb), can be None if no gases are included in simulation
trajectory_data = pickle.load(open('../example_datasets/example_pichamber_trajectory.pkl', 'rb'))

# Step 3: Run the pi chamber simulation
simulate_les_trajectory(
    ...
    write_every=10.0, condensation=True, gas_chemistry=False, 
    cocondensation=False, relaxation_time=0.0)
