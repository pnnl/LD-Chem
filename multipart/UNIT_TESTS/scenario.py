...
def make_monodisperse_population(D, N, aero_spec_names, aero_spec_fracs, specdata_path='../species_data/'):
    if 'H2O' not in aero_spec_names:
    # if len([spec_name.upper()=='H2O' for spec_name in aero_spec_names]) == 0:
        aero_spec_names.append('H2O')
        aero_spec_fracs = np.append(aero_spec_fracs, 0.)
...
def make_polydisperse_population(Ds, Ns, aero_spec_names, aero_spec_fracs, specdata_path='../species_data/',surface_tension=0.072):
