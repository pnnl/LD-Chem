...
ax11.plot(Vs, max_S, '-r')
ax21.plot(Vs, activated_fraction, '-r')
...
ax12.plot(np.array((Ntot))/100**3, max_S, '-r')
ax22.plot(np.array((Ntot))/100**3, activated_fraction, '-r')
...
ax13.plot(0.5*np.array((number_mode_diameter))*1e6, max_S, '-r')
ax23.plot(0.5*np.array((number_mode_diameter))*1e6, activated_fraction, '-r')
