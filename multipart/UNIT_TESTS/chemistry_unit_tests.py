...
files = ['particles.py', 'constants.py', 'scenario.py', 'aerosol_species.py',
         'utilities.py', 'systems.py', 'driver.py', 'visualization.py', 'TraceGases.py']
...
trajectory_ensemble = simulate_chemistry_tests(N_scenarios=1,
        ...
        gas_names=['SO2','O3'], gas_conc=[1.0,5.0],
        radius_scale='log',solver='ode15s',
        specdata_path='species_data/', mechanism_data_path='mechanisms/',
        condensation = True, 
        collisions = False, settling = False,
        cocondensation = True, chemistry = False, freezing = False)

# visualization.plot_parcel_trajectory(trajectory_ensemble[0], axis='time')
