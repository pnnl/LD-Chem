...
python3 ../../multipart/RESTART_les.py /Users/beel083/Library/CloudStorage/OneDrive-PNNL/Desktop/codes/multipart_archived/test/trajectory_5 ${restart_file} ${trajectory_file}
